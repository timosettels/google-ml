                    ...
                    public void onSuccess(List<Barcode> barcodes) {
                        ...
                        for (Barcode barcode : barcodes) {
                            ...
                            if(cornerPoints != null && cornerPoints.length > 0) {
                                Point cornerPoint1 = cornerPoints[0];
                                barcodeMap.put("cornerPoint1.x", cornerPoint1.x);
                                barcodeMap.put("cornerPoint1.y", cornerPoint1.y);
                                Point cornerPoint2 = cornerPoints[1];
                                barcodeMap.put("cornerPoint2.x", cornerPoint2.x);
                                barcodeMap.put("cornerPoint2.y", cornerPoint2.y);
                                Point cornerPoint3 = cornerPoints[2];
                                barcodeMap.put("cornerPoint3.x", cornerPoint3.x);
                                barcodeMap.put("cornerPoint3.y", cornerPoint3.y);
                                Point cornerPoint4 = cornerPoints[3];
                                barcodeMap.put("cornerPoint4.x", cornerPoint4.x);
                                barcodeMap.put("cornerPoint4.y", cornerPoint4.y);
                            }
                            switch (valueType) {
