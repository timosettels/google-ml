...
- (NSDictionary *)barcodeToDictionary:(MLKBarcode *)barcode {
    ...
    //NSLog(@"%li", [barcode.cornerPoints count]);
    [dictionary addEntriesFromDictionary:@{
        ...
        @"cornerPoint1.x" : @([barcode.cornerPoints[0] CGPointValue].x),
        @"cornerPoint1.y" : @([barcode.cornerPoints[0] CGPointValue].y),
        @"cornerPoint2.x" : @([barcode.cornerPoints[1] CGPointValue].x),
        @"cornerPoint2.y" : @([barcode.cornerPoints[1] CGPointValue].y),
        @"cornerPoint3.x" : @([barcode.cornerPoints[2] CGPointValue].x),
        @"cornerPoint3.y" : @([barcode.cornerPoints[2] CGPointValue].y),
        @"cornerPoint4.x" : @([barcode.cornerPoints[3] CGPointValue].x),
        @"cornerPoint4.y" : @([barcode.cornerPoints[3] CGPointValue].y),
    }];
