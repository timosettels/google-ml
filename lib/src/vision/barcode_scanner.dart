...
class BarcodeValue {
  ...
  final Point<double>? cornerPoint1;

  final Point<double>? cornerPoint2;

  final Point<double>? cornerPoint3;

  final Point<double>? cornerPoint4;
  ...
  BarcodeValue._(Map<dynamic, dynamic> barcodeData)
      : type = BarcodeType.values[barcodeData['type']],
        ...
        cornerPoint1 = barcodeData['cornerPoint1.x'] != null &&
            barcodeData['cornerPoint1.y'] != null ? Point((barcodeData['cornerPoint1.x']).toDouble(),
            (barcodeData['cornerPoint1.y']).toDouble()) : null,
        cornerPoint2 = barcodeData['cornerPoint2.x'] != null &&
            barcodeData['cornerPoint2.y'] != null ? Point((barcodeData['cornerPoint2.x']).toDouble(),
            (barcodeData['cornerPoint2.y']).toDouble()) : null,
        cornerPoint3 = barcodeData['cornerPoint3.x'] != null &&
            barcodeData['cornerPoint3.y'] != null ? Point((barcodeData['cornerPoint3.x']).toDouble(),
            (barcodeData['cornerPoint3.y']).toDouble()) : null,
        cornerPoint4 = barcodeData['cornerPoint4.x'] != null &&
            barcodeData['cornerPoint4.y'] != null ? Point((barcodeData['cornerPoint4.x']).toDouble(),
            (barcodeData['cornerPoint4.y']).toDouble()) : null,
